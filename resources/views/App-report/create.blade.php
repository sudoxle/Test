    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('Apprehension-report.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('IRS_Number',' Name_App_Operator','Violations') ? ' has-error' : '' }} ">
                            ...
                            <div class="col-md-2">
                                <input id="IRS_Number" type="text" class="form-control" name="IRS_Number" value="{{ old('IRS_Number') }}" required autofocus>
                            ...
                            <div class="col-md-2">
                                <input id="Name_App_Operator" type="text" class="form-control" name="Name_App_Operator" value="{{ old('Name_App_Operator') }}" required>
                            ...
                            <div class="col-md-2">
                                <input id="Violations" type="text" class="form-control" name="Violations" value="{{ old('Violations') }}" required>
                ...
                <div class="form-group {{ $errors->has('Case_Number','Type_service') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <input id="Case_Number" type="text" class="form-control" name="Case_Number" value="{{ old('Case_Number') }}" required>
                            ...
                            <div class="col-md-5">
                                <input id="Type_service" type="text" class="form-control" name="Type_service" value="{{ old('Type_service') }}" required>
             ...
             <!-- EDIT THIS -->               <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <input id="MVIR_serial" type="text" class="form-control" name="MVIR_serial" value="{{ old('MVIR_serial') }}" >
                 ...
                 <!-- EDIT THIS -->           <div class="col-md-2">
                            ...
                            <div class="col-md-2 ">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ old('Date_of_payment') }}" name="Date_of_payment" class="form-control pull-right" id="Date_of_payment">
                                </div>
                            </div>

                            <label class="col-md-1 control-label">Release Order</label>
                            <div class="col-md-2">
                                <input id="Release_order" type="text" class="form-control" name="Release_order" value="{{ old('Release_order') }}" >
                            </div>
                            ...
                            <div class="col-md-2 ">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ old('Date_of_released') }}" name="Date_of_released" class="form-control pull-right" id="Date_of_released">
                                </div>
                            </div>
                        </div>
